...
class _LightMeterPageState extends State<LightMeterPage> with SingleTickerProviderStateMixin {
  ...
  String _getLightStatus() {
    if (_currentLux < 500) return "Düşük Işık (Gölge)";
    if (_currentLux < 2000) return "Orta Işık (Aydınlık Oda)";
    if (_currentLux < 10000) return "Yüksek Işık (Pencere Önü)";
    return "Çok Yüksek Işık (Direkt Güneş)";
  }
  ...
  String _getRecommendation() {
    if (_currentLux < 500) return "Calathea, Eğrelti Otu veya Paşa Kılıcı için uygundur.";
    if (_currentLux < 2000) return "Monstera, Ficus, Antoryum için ideal ortamdır.";
    if (_currentLux < 10000) return "Aлое, Kaktüs ve Sardunya gibi güneşi sevenlere uygundur.";
    return "Dış mekan bitkileri ve sukulentler için en iyi noktadır.";
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Telefonun ön kamerasını bitkinin\nbulunduğu alana (ışık kaynağına) doğru tutun.',
                  ...
                  children: [
                    AnimatedContainer(
                      ...
                      child: AnimatedSwitcher(
                        ...
                        child: Text(
                          _getLightStatus(),
                          key: ValueKey<String>(_getLightStatus()),
                          style: GoogleFonts.inter(
                            color: _getStatusColor(),
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                    ...
                    Row(
                      ...
                      children: [
                        const Icon(Icons.info_outline_rounded, color: Color(0xFF8B9E93), size: 20),
